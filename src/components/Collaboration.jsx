            ...
            <ul>
              <li className="Collabs rotate-0">
                <div className="rotate-0">
                  <img src={figma} alt="Figma" width={34} height={36} />
                </div>
              </li>
              <li className="Collabs rotate-[45deg]">
                <div className="-rotate-[45deg]">
                  <img src={notion} alt="Notion" width={34} height={36} />
                </div>
              </li>
              <li className="Collabs rotate-[90deg]">
                <div className="-rotate-[90deg]">
                  <img src={discord} alt="Discord" width={34} height={36} />
                </div>
              </li>
              <li className="Collabs rotate-[135deg]">
                <div className="-rotate-[135deg]">
                  <img src={slack} alt="Slack" width={34} height={36} />
                </div>
              </li>
              <li className="Collabs rotate-[180deg]">
                <div className="rotate-[180deg]">
                  <img src={photoshop} alt="PhotoShop" width={34} height={36} />
                </div>
              </li>
              <li className="Collabs rotate-[225deg]">
                <div className="-rotate-[225deg]">
                  <img src={protopie} alt="Protopie" width={34} height={36} />
                </div>
              </li>
              <li className="Collabs rotate-[270deg]">
                <div className="-rotate-[270deg]">
                  <img src={framer} alt="Framer" width={34} height={36} />
                </div>
              </li>
              <li className="Collabs rotate-[315deg]">
                <div className="-rotate-[315deg]">
                  <img src={raindrop} alt="RainDrop" width={34} height={36} />
                </div>
              </li>
            </ul>
            <LeftCurve />
