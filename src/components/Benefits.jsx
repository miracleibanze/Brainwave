  ...
  return (
    <Section id="Features">
      ...
      <div className="flex flex-wrap gap-10 mb-10 justify-center">
        ...
        <div
          className="benefit-card"
          style={{ backgroundImage: `url(${benefitCard2})` }}
        >
          <div className="innerBenefitCard ">
        ...
        <div
          className="benefit-card"
          style={{ backgroundImage: `url(${benefitCard3})` }}
        >
          <div className="innerBenefitCard ">
        ...
        <div
          className="benefit-card"
          style={{ backgroundImage: `url(${benefitCard4})` }}
        >
          <div className="innerBenefitCard ">
        ...
        <div
          className="benefit-card"
          style={{ backgroundImage: `url(${benefitCard5})` }}
        >
          <div className="innerBenefitCard ">
            <h5 className="h5 mb-5">Ask anything</h5>
            <p className="body-2 mb-6 text-n-3">
        ...
        <div
          className="benefit-card"
          style={{ backgroundImage: `url(${benefitCard6})` }}
        >
          <div className="innerBenefitCard ">
            <h5 className="h5 mb-5">Improve everyday</h5>
            <p className="body-2 mb-6 text-n-3">
